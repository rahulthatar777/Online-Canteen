...
<body>
    ...
    <h1 style="text-align:center;font-size:50px;color:gray;padding-top:30px;padding-bottom:50px;padding-left:10px"> My Profile </h1>
			...
			echo "<table style='border-color:#fff;' >";
				...
				echo "<tr>";
					echo "<td colspan='3' style='padding:.75rem;vertical-align:top;border-top:1px solid #fff;'>"; ?>
						<center>
							<a href="gsrshop.php?s_id=<?php echo $a; ?>" class=" btn hvr-hover">Update Profile</a>
						</center>
					<?php 
					echo "</td>";
				echo "</tr>";
