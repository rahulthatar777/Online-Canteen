        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/logo3.png" class="logo" alt=""></a>
                </div>
				...
				<div class="row">
					<div class="col-lg-8 col-sm-12">
						<div class="contact-form-right">
							<form  action= "pforgotpass.php" enctype="multipart/form-data" method="post">
								<h2>FORGOT-PASSWORD</h2>
								<br/>
								<div class="row">
									<label for="selector1"  class="col-sm-2 control-label"><h3>ROLE:</h3></label>
									<div class="col-md-12">
										<div class="col-md-6">
											<div class="form-group">
												<select name="l1" id="statedd" class="form-control">
										...
										<div class="col-md-12">
											<div class="form-group">
												<input type="text" class="form-control" id="name" placeholder="USERNAME" name="l2" required>
											</div>
										</div>
									</div>
								</div>
