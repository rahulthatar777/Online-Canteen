	...
	<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbar-menu">
						<ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
							...
							<li class="nav-item active"><a class="nav-link" href="vieworder.php">VIEW ORDERS</a></li>
	    ...
	    <div class="all-title-box">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2>View Orders Detail</h2>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Shop</a></li>
							<li class="breadcrumb-item active">ORDERS_DETAIL</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<table class="table">
								...
								<tbody>
									<?php		
										...
										inner join productupload on productupload.p_id= book_order.p_id where stid=$a";
										//echo $str;
