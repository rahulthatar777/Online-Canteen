...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="profileshop.php">PROFILE</a></li>
	...
	<?php
		...
		if(isset($_GET['s_id']))
		{
			...
			$str="select * from shopkeeper_reg where s_id=".$_GET['s_id'];
					...
					<div class="col-lg-8 col-sm-12">
						<div class="contact-form-right">
							<form  action= "<?php
												if(isset($_GET['s_id']))
												{
													echo"editproshop.php?s_id=".$_GET['s_id'];
												}
												else
												{
													echo"addstate.php";
								...
								<h2>SHOP REGISTRTION FORM:</h2>
								<br/>
								<div class="row">
									
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" placeholder="OWNER NAME" value="<?php echo $a; ?>" name="sp1" required>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" placeholder="SHOP NAME" value="<?php echo $b; ?>" name="sp2" required>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<textarea class="form-control" id="message" placeholder="ADDRESS" rows="4" name="sp3" required><?php echo $c; ?></textarea>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="email" class="form-control" id="email" placeholder="EMIAL" value="<?php echo $d; ?>" name="sp4" required>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" placeholder="MOBILE NO." value="<?php echo $e; ?>" name="sp5" required>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" placeholder="CREATE USER NAME" value="<?php echo $f; ?>" name="sp6" required>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											<select onChange="change_state()" class="form-control" name="sp7" id="statedd">
