				...
				<div class="row">
					<div class="col-lg-8 col-sm-12">
						<div class="contact-form-right">
							<form  action= "plogin.php" enctype="multipart/form-data" method="post">
								<h2>LOGIN</h2>
								<br/>
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="col-md-12">
											<div class="form-group">
												<input type="password" class="form-control" id="name" placeholder="PASSWORD" value="" name="l3" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
