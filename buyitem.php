            ...
            <div class="row">
					<?php		
						...
						echo '<div class="col-xl-5 col-lg-5 col-md-6">';
							echo '<div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">';
								echo '<div class="carousel-inner" role="listbox">';
									echo '<div class="carousel-item active">'; ?>
										<img class="d-block w-100" src="admin/<?php echo $a; ?>" alt="First slide"> <?php
									echo '</div>';
								echo '</div>';
							echo '</div>';
						echo '</div>';
						echo '<div class="col-xl-7 col-lg-7 col-md-6">';
							echo '<div class="single-product-details">';
								$t=$_GET['p_id'];
								echo'<form  action= "recitem.php?p_id='.$t.'" method="post">';
									echo "<h2>$b</h2>";
									echo "<h5> <del>₹ 60.00</del> ₹ $c</h5>";
									echo '<h4>Food Description:</h4>';
									echo "<p>$d. </p>";
									echo '<ul>';
										echo '<li>';
											echo '<div class="form-group quantity-box">';
												echo '<label class="control-label">Quantity</label>';
												echo '<input class="form-control" value="1" min="1" max="20" name="b1" type="number">';
											echo '</div>';
										echo '</li>';
									echo '</ul>';
