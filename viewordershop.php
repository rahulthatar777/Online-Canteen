								...
								<?php		
									...
									while($row=mysqli_fetch_array($result))
									{
										...
										<tr>
											...
											<td class='total-pr'>
												<a href="accitem.php?orderid=<?php echo $j; ?>" class=" btn hvr-hover">Accept</a>
											</td>
											<td class='total-pr'>
												<a href="rejorder.php?orderid=<?php echo $j; ?>" class=" btn hvr-hover">Reject</a>
											</td>
										</tr>
									<?php } ?>
							</tbody>
