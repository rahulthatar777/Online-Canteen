            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
						...
						<li class="nav-item active"><a class="nav-link" href="lastorderon.php">PREVIOUS ORDERS</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2>ALL_Orders</h2>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="mainshop">Home</a></li>
							<li class="breadcrumb-item">All_Orders</li>
						</ul>
					</div>
				</div>
			</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
								<?php		
									...
									inner join productupload on productupload.p_id= book_order.p_id where sid='$a'";
									//echo $str;
