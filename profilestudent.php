...
<?php
	...
	inner join city on city.cityid= student_reg.city	where stid='$a' ";
    $result= mysqli_query($con,$str);
    $row=mysqli_fetch_assoc($result);

   // echo "<div><img src='profileimages/".$_SESSION['pic']." ></div>";
	echo "<div style='text-align:center;padding-bottom:35px;'><img class='img-circle profile-img' height=250 width=300 src='admin/$row[photo]'></div>";
		echo "<div class='wrapper' style=' width : 500px;  margin: 0 auto; padding-left:80px;'>";

			echo"<b>";
			echo "<table style='border-color:#eb5424;' class='table'>";
				echo "<tr>";
				...
				echo "<tr>";
					echo "<td colspan='3' style='padding:.75rem;vertical-align:top;border-top:1px solid #fff;'>";?>
						<center>
							<a href="gsrstudent.php?stid=<?php echo $a; ?>" class=" btn hvr-hover">Update Profile</a>
						</center>
					<?php 
					echo "</td>";
				echo "</tr>";
