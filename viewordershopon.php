            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
						...
						<li class="nav-item active"><a class="nav-link" href="viewordershopon.php">NEW ORDERS</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="viewordershopon.php">Pending_Orders</a></li>
							<li class="breadcrumb-item"><a href="viewaordershopon.php">Accepted_Orders</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<?php		
									...
									while($row=mysqli_fetch_array($result))
									{
										...
										<tr>
											...
											<td class='total-pr'>
												<a href="accitemon.php?orderid=<?php echo $j; ?>" class=" btn hvr-hover">Accept</a>
											</td>
											<td class='total-pr'>
												<a href="rejorderon.php?orderid=<?php echo $j; ?>" class=" btn hvr-hover">Reject</a>
											</td>
										</tr>
									<?php } ?>
							</tbody>
